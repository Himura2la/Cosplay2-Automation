...
def make_filename(data, num, dl_title=None):
    ...
    if req_data['sound_start']:
        sound_start = {
            ...
            'Трек запускается после выхода на сцену (с точки, без реквезита)': 'С точки',
            'Трек запускается сразу после выноса реквизита (когда на сцене никого)': 'Стафф,Сразу',
            'Трек запускается сразу после выноса реквезита (когда на сцене никого)': 'Стафф,Сразу',
            'Трек запускается после выноса реквизита и выхода на точку': 'Стафф,ТЧК',
            'Трек запускается после выноса реквезита и выхода на точку': 'Стафф,ТЧК',
