...
author_contacts = '(vk.com/gl_2la или t.me/Himura_Kazuto)'
...
# заархивируйте эту папку и скиньте Химуре {author_contacts}.
...
"""
        ...
        input('\nК сожалению, произошла неведомая фигня. Выше есть немного технических деталей...\n' +
            f'Пожалуйста, свяжитесь с Химурой {author_contacts}, ' + 
            'и покажите ему это...\n' +
