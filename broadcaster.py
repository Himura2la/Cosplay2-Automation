...
# comment = """
# Поздравляем с прохождением отбора в сценическую программу YnO 15! ╰(*°▽°*)╯

# И сообщаем, что готова предварительная программа фестиваля!

# ⚠ Важное напоминание: перемещение номеров возможно только по серьезной причине и в рамках подблоков вашей номинации в текущем или других блоках программы. Если в нужном вам блоке нет блока нужной номинации, перемещение туда невозможно!
# Пожелания принимаются до 21 февраля 20:00. Все пожелания, отправленные после указанного времени, может быть невозможно исполнить.

# Оставить свои пожелания по перемещениям вы можете в комментариях к посту: https://vk.com/wall-20362122_30397
# А программа вот: https://vk.com/@tulaanimefest-yno15-plan

# До фестиваля осталось совсем немного, так что, пожалуйста, не пишите больше ничего сюда в комментарии к заявке, организаторы уже их не читают, 
# они могут потеряться (。﹏。*)
# Все срочные дела просьба решать с вашим координатором в ЛС.
# """.strip()

comment = """
Ждём Вас в субботу 28.02 с 8 утра на входе участников Тульского Городского Концертного Зала (справа от главного, возле парковки). Репетиция с 8:30 до 11:30. Просьба знать свой номер: {} (он ещё должен был в смс прийти, и на бейдже будет)!
В группе ВК есть актуальная программа шоу: https://vk.com/@tulaanimefest-yno15-plan

Если вы хотите отслеживать, какой номер выступает на сцене, можно вступить в чат https://t.me/+X604ZUp9TUIxNWMy
В случае недоступности Telegram, следить за программой можно по ссылке https://yno.datakeep.ru/
""".strip()  # -------------------------------------------- 1 SMS ->|      --------- 2 SMS with "YnO14, заявка 000: " ->|
