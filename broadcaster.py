...
Полная программа в нашем телеграм-канале: @tofu_fest
Ждём Вас в воскресенье 22.12 с 12:00 на входе в музей NPAK.
Репетиция с 12.30 до 14.30, на репетиции потребуется назвать свой номер, запишите его плиз!
Всё самое важное будет в телеграм канале @tofu_fest (tofu_fest.t.me) рекомендуем на него подписаться, если вы ещё не ^_^
Пожалуйста, не пишите больше сюда в комментарии к заявкам, их уже никто не читает.
По любым срочным вопросам просьба связываться с организаторами в Telegram!
""".strip()  # --------------------------------------------- 1 SMS ->|      --------- 2 SMS with "YnO9, заявка 000: " ->|
target = "status != 'disapproved' and default_duration > 0 and card_code not like 'V%' and card_code not like 'A%' AND requests.voting_number NOT IN (305,109)"
email = True
sms = False
